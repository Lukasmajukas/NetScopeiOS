...
|-----|---------------|-------|
| **Speed** | ✅ Fully | Animated gauge, live download/upload/ping, ISP + Cloudflare server, history saved forever, **Ookla-format CSV export** (Date, ConnType, Lat/Lon, Download/Upload in kbps, total bytes, Latency, ServerName, internal/external IP, VPN flag) via the share sheet. |
